...
@Component({
  selector: 'app-process-manager-to-action',
  templateUrl: './process-manager-to-action.component.html',
  styleUrls: ['./process-manager-to-action.component.scss']
})
export class ProcessManagerToActionComponent implements OnInit {
