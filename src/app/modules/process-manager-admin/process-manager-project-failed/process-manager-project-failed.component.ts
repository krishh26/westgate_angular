...
@Component({
  selector: 'app-process-manager-project-failed',
  templateUrl: './process-manager-project-failed.component.html',
  styleUrls: ['./process-manager-project-failed.component.scss']
})
export class ProcessManagerProjectFailedComponent implements OnInit {
