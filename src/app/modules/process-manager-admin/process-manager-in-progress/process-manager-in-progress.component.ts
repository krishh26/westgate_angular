...
@Component({
  selector: 'app-process-manager-in-progress',
  templateUrl: './process-manager-in-progress.component.html',
  styleUrls: ['./process-manager-in-progress.component.scss']
})
export class ProcessManagerInProgressComponent implements OnInit {
