...
@Component({
  selector: 'app-process-manager-completed',
  templateUrl: './process-manager-completed.component.html',
  styleUrls: ['./process-manager-completed.component.scss']
})
export class ProcessManagerCompletedComponent implements OnInit {
