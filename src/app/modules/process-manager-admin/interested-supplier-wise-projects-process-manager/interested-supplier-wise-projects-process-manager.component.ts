...
@Component({
  selector: 'app-interested-supplier-wise-projects-process-manager',
  templateUrl: './interested-supplier-wise-projects-process-manager.component.html',
  styleUrls: ['./interested-supplier-wise-projects-process-manager.component.scss']
})
export class InterestedSupplierWiseProjectsProcessManagerComponent implements OnInit {
  ...
  projectDetails(projectId: any) {
    this.router.navigate(
      ['/process-manager/process-manager-project-details'],
