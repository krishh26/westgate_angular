...
@Component({
  selector: 'app-project-cordinator-profile',
  templateUrl: './project-cordinator-profile.component.html',
  styleUrls: ['./project-cordinator-profile.component.scss']
})
export class ProjectCordinatorProfileComponent {
  userData!: any;
  skills: any[] = [
    {
      id: 1,
