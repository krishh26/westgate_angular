...
@Component({
  selector: 'app-myday-todo-task-sales-manager',
  templateUrl: './myday-todo-task.component.html',
  styleUrls: ['./myday-todo-task.component.scss'],
  animations: [
    trigger('slideInOut', [
      state('in', style({
        height: '*',
...
export class MydayTodoTaskSalesManagerComponent implements OnInit {
  taskDetails: string = '';
  taskTitle: string = '';
