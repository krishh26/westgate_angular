...
@Component({
  selector: 'app-bid-submission-profile',
  templateUrl: './bid-submission-profile.component.html',
  styleUrls: ['./bid-submission-profile.component.scss']
})
export class BidSubmissionProfileComponent {
  userData!: any;
  skills: any[] = [
    {
      id: 1,
