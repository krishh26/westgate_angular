...
@Component({
  selector: 'app-shortlisted-supplier-project-list',
  templateUrl: './shortlisted-supplier-project-list.component.html',
  styleUrls: ['./shortlisted-supplier-project-list.component.css']
})
export class ShortlistedSupplierProjectListComponent implements OnInit {
  ...
  getProjectList() {
    this.showLoader = true;
    Payload.pmShortlistsupplierProjectList.keyword = this.searchText;
    Payload.pmShortlistsupplierProjectList.page = String(this.page);
    Payload.pmShortlistsupplierProjectList.limit = String(this.pagesize);
  ...
  searchtext() {
    ...
    Payload.pmAllProjectList.selectedSupplier = true;
