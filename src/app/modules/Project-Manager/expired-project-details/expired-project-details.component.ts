...
@Component({
  selector: 'app-expired-project-details',
  templateUrl: './expired-project-details.component.html',
  styleUrls: ['./expired-project-details.component.css']
})
export class ExpiredProjectDetailsComponent implements OnInit {
