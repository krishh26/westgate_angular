...
@Component({
  selector: 'app-no-supplier-match-projects',
  templateUrl: './no-supplier-match-projects.component.html',
  styleUrls: ['./no-supplier-match-projects.component.scss']
})
export class NoSupplierMatchProjectsComponent {
