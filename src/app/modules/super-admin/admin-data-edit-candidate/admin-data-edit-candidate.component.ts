...
@Component({
  selector: 'app-admin-data-edit-candidate',
  templateUrl: './admin-data-edit-candidate.component.html',
  styleUrls: ['./admin-data-edit-candidate.component.scss']
})
export class AdminDataEditCandidateComponent implements OnInit {
