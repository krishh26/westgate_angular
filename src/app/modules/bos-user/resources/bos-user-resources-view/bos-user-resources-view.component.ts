...
import { BosUserResourcesCommentModalComponent } from '../bos-user-resources-comment-modal/bos-user-resources-comment-modal.component';
import { BosUserResourcesAddBulkComponent } from '../bos-user-resources-add-bulk/bos-user-resources-add-bulk.component';

@Component({
  selector: 'app-bos-user-resources-view',
  templateUrl: './bos-user-resources-view.component.html',
  styleUrls: ['./bos-user-resources-view.component.scss']
})
export class BosUserResourcesViewComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe(params => {
      if (params['roleId']) {
        ...
        this.router.navigate(['/boss-user/bos-user-roles-wise-resources-list']);
      }
    });
  ...
  openCommentModal(item: any) {
    ...
    const modalRef = this.modalService.open(BosUserResourcesCommentModalComponent, { centered: true });
  ...
  openAddResourceModal() {
    this.modalService.open(BosUserResourcesAddBulkComponent, { size: 'xl' });
  }

  viewCandidateDetails(candidate: any) {
    console.log('Viewing candidate details:', candidate);

    this.router.navigate(['/boss-user/bos-user-resources-view-details'], {
      queryParams: {
