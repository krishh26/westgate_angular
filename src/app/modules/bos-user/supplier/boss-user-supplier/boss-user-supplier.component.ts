...
@Component({
  selector: 'app-boss-user-supplier',
  templateUrl: './boss-user-supplier.component.html',
  styleUrls: ['./boss-user-supplier.component.scss']
})
export class BossUserSupplierComponent {
