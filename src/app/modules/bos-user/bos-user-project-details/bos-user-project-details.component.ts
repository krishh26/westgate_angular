...
@Component({
  selector: 'app-bos-user-project-details',
  templateUrl: './bos-user-project-details.component.html',
  styleUrls: ['./bos-user-project-details.component.scss']
})
export class BosUserProjectDetailsComponent {
